    ...
    extends SectionType
{
    ...
    public static class Property {
        ...
        @XmlAttribute(name = "key", namespace = "http://schemas.dmtf.org/ovf/environment/1", required = true)
        protected String key;
        @XmlAttribute(name = "value", namespace = "http://schemas.dmtf.org/ovf/environment/1", required = true)
