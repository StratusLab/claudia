...
public class FileType {
    ...
    protected String id;
    @XmlAttribute(name = "href", namespace = "http://schemas.dmtf.org/ovf/envelope/1", required = true)
    @XmlSchemaType(name = "anyURI")
    protected String href;
    @XmlAttribute(name = "size", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
    @XmlSchemaType(name = "unsignedLong")
    protected BigInteger size;
    @XmlAttribute(name = "compression", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
    protected String compression;
    @XmlAttribute(name = "chunkSize", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
