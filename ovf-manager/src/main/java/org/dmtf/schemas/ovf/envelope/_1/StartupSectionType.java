    ...
    extends SectionType
{
    ...
    public static class Item {
        ...
        protected String id;
        @XmlAttribute(name = "order", namespace = "http://schemas.dmtf.org/ovf/envelope/1", required = true)
        @XmlSchemaType(name = "unsignedShort")
        protected int order;
        @XmlAttribute(name = "startDelay", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
        @XmlSchemaType(name = "unsignedShort")
        protected Integer startDelay;
        @XmlAttribute(name = "waitingForGuest", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
        protected Boolean waitingForGuest;
        @XmlAttribute(name = "stopDelay", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
        @XmlSchemaType(name = "unsignedShort")
        protected Integer stopDelay;
        @XmlAttribute(name = "startAction", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
        protected String startAction;
        @XmlAttribute(name = "stopAction", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
