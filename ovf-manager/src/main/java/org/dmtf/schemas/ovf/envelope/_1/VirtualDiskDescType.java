...
public class VirtualDiskDescType {
    ...
    @XmlAttribute(name = "diskId", namespace = "http://schemas.dmtf.org/ovf/envelope/1", required = true)
    protected String diskId;
    @XmlAttribute(name = "fileRef", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
    protected String fileRef;
    @XmlAttribute(name = "capacity", namespace = "http://schemas.dmtf.org/ovf/envelope/1", required = true)
    ...
    @XmlAttribute(name = "populatedSize", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
