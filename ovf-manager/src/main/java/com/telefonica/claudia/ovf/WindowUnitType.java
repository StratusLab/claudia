...
/**
 * <p>Java class for WindowUnit_Type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="WindowUnit_Type">
...
public enum WindowUnitType {
    ...
    public static WindowUnitType fromValue(String v) {
        for (WindowUnitType c: WindowUnitType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
