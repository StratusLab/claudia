...
/**
 * <p>Java class for AffinityScope_Type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AffinityScope_Type">
 ...
 * 
 */
@XmlType(name = "AffinityScope_Type")
@XmlEnum
public enum AffinityScopeType {

    @XmlEnumValue("physical")
    PHYSICAL("physical"),
    @XmlEnumValue("datacenter")
    DATACENTER("datacenter"),
    @XmlEnumValue("domain")
    DOMAIN("domain");
    private final String value;

    AffinityScopeType(String v) {
        value = v;
    }
    ...
    public static AffinityScopeType fromValue(String v) {
        for (AffinityScopeType c: AffinityScopeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
