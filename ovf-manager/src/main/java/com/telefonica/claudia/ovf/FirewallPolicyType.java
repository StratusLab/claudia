...
/**
 * <p>Java class for FirewallPolicy_Type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="FirewallPolicy_Type">
 ...
 * 
 */
@XmlType(name = "FirewallPolicy_Type")
@XmlEnum
public enum FirewallPolicyType {
    ...
    public static FirewallPolicyType fromValue(String v) {
        for (FirewallPolicyType c: FirewallPolicyType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
