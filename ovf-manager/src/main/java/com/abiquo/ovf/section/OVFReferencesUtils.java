...
public class OVFReferencesUtils
{
     ...
     */
    public static void addOtherAttributes(FileType fileType, QName key, String value) throws RequiredAttributeException, IdAlreadyExistsException
    {
        if (fileType == null || key == null)
        {
            throw new RequiredAttributeException("Some values are null!");
        }
        if (fileType.getOtherAttributes().get(key) != null)
        {
            throw new IdAlreadyExistsException("Key already exists");
        }
        fileType.getOtherAttributes().put(key, value);

    }
    
    /**
     * Return an OtherAttributes value for a given key into the <File>
     * @param fileType
     * @param key
     * @return
     ...
     */
    public static String getOtherAttribute(FileType fileType, QName key) throws RequiredAttributeException, IdNotFoundException
    {
        if (fileType == null || key == null)
        {
            throw new RequiredAttributeException("Some values are null!");
        ...
        String value = fileType.getOtherAttributes().get(key);
