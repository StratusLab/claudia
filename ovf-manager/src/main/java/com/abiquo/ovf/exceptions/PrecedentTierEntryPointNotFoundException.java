...
public class PrecedentTierEntryPointNotFoundException extends Exception {	

	public PrecedentTierEntryPointNotFoundException(String message)
    {
        super(message);
    }

    public PrecedentTierEntryPointNotFoundException(String message, Throwable cause)
    {
        super(message, cause);
    }
