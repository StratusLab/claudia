...
public class NetmaskNotFoundException extends Exception{

	public NetmaskNotFoundException(String message)
    {
        super(message);
    }

    public NetmaskNotFoundException(String message, Throwable cause)
    {
        super(message, cause);
    }
