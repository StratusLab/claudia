...
public class NotEnoughIPsInPoolException  extends Exception{
		
	private static final long serialVersionUID = -957907148912007893L;

	public NotEnoughIPsInPoolException(String message)
    {
        super(message);
    }

    public NotEnoughIPsInPoolException(String message, Throwable cause)
    {
        super(message, cause);
    }
