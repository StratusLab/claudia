...
public class DNSServerNotFoundException extends Exception{

	public DNSServerNotFoundException(String message)
    {
        super(message);
    }

    public DNSServerNotFoundException(String message, Throwable cause)
    {
        super(message, cause);
    }
