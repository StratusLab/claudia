...
public class ImageTemplateMetadata  implements java.io.Serializable {
    ...
    /**
     * Gets the image_id value for this ImageTemplateMetadata.
     * 
     * @return image_id
     */
    ...
    /**
     * Sets the image_id value for this ImageTemplateMetadata.
     * 
     * @param image_id
     */
    ...
    /**
     * Gets the public_metadata value for this ImageTemplateMetadata.
     * 
    ...
    /**
     * Sets the public_metadata value for this ImageTemplateMetadata.
     * 
    ...
    /**
     * Gets the private_metadata value for this ImageTemplateMetadata.
     * 
    ...
    /**
     * Sets the private_metadata value for this ImageTemplateMetadata.
     * 
    ...
    /**
     * Gets the restricted_metadata value for this ImageTemplateMetadata.
     * 
    ...
    /**
     * Sets the restricted_metadata value for this ImageTemplateMetadata.
     * 
    ...
    /**
     * Gets the system_metadata value for this ImageTemplateMetadata.
     * 
    ...
    /**
     * Sets the system_metadata value for this ImageTemplateMetadata.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ImageTemplateMetadata)) return false;
        ImageTemplateMetadata other = (ImageTemplateMetadata) obj;
        ...
        boolean _equals;
        _equals = true && 
            this.image_id == other.getImage_id() &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        _hashCode += new Long(getImage_id()).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ImageTemplateMetadata.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://extility.flexiant.com", "ImageTemplateMetadata"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("image_id");
        elemField.setXmlName(new javax.xml.namespace.QName("", "image_id"));
