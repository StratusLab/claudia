...
public class URICreationPaaS {
	...
	public static final String URI_VAPP  = URI_VDC   + "/applications/{vapp-id}";
	
	public static final String URI_VAPP_SDC  =  "/applications/{vapp-id}";
...
//	}
	...
	public static String getReplica(String fqn) {
		...
		String replica = fqn.substring(fqn.indexOf(URICreationPaaS.FQN_SEPARATOR_REPLICA)+URICreationPaaS.FQN_SEPARATOR_REPLICA.length() + 1);
	...
	public static String getURIService(String fqn) {
		...
		return URI_VAPP_SDC.replace("{vapp-id}", service);
	}
